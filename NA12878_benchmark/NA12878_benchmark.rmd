...
## BreakpointRanges
```{r caller_svgr generation, warning=FALSE}
setwd("~/GitRepo/summerproject2021/NA12878_benchmark/Maestro_scripts/VCF")
# full-sized
...
```{r Precision X Recall plot <ORIGINAL>, eval=FALSE}
# Delineate each term
...
```{r svgr med_svgr small_svgr generation, warning=FALSE, eval=FALSE}
...
large_svgr$truth_matches <- countBreakpointOverlaps(large_svgr, truth_svgr,
...
Does this differ from the above:
```{r warning=FALSE}
# large
...
# medium
med_delly_svgr$truth_matches <- countBreakpointOverlaps(med_delly_svgr, 
                                              truth_svgr, 
                                              maxgap=100, sizemargin=0.25,
                                              restrictMarginToSizeMultiple=0.5, countOnlyBest=TRUE)
med_manta_svgr$truth_matches <- countBreakpointOverlaps(med_manta_svgr, 
                                              truth_svgr, 
                                              maxgap=100, sizemargin=0.25,
                                              restrictMarginToSizeMultiple=0.5, countOnlyBest=TRUE)
med_melt_svgr$truth_matches <- countBreakpointOverlaps(med_melt_svgr, 
                                             truth_svgr, 
                                             maxgap=100, sizemargin=0.25,
                                             restrictMarginToSizeMultiple=0.5, countOnlyBest=TRUE)
med_wham_svgr$truth_matches <- countBreakpointOverlaps(med_wham_svgr, 
                                             truth_svgr, 
                                             maxgap=100, sizemargin=0.25,
                                             restrictMarginToSizeMultiple=0.5, countOnlyBest=TRUE)
med_svaba_svgr$truth_matches <- countBreakpointOverlaps(med_svaba_svgr, 
                                             truth_svgr, 
                                             maxgap=100, sizemargin=0.25,
                                             restrictMarginToSizeMultiple=0.5, countOnlyBest=TRUE)
...
# small
small_delly_svgr$truth_matches <- countBreakpointOverlaps(small_delly_svgr, 
                                              truth_svgr, 
                                              maxgap=100, sizemargin=0.25,
                                              restrictMarginToSizeMultiple=0.5, countOnlyBest=TRUE)
small_manta_svgr$truth_matches <- countBreakpointOverlaps(small_manta_svgr, 
                                              truth_svgr, 
                                              maxgap=100, sizemargin=0.25,
                                              restrictMarginToSizeMultiple=0.5, countOnlyBest=TRUE)
small_melt_svgr$truth_matches <- countBreakpointOverlaps(small_melt_svgr, 
                                             truth_svgr, 
                                             maxgap=100, sizemargin=0.25,
                                             restrictMarginToSizeMultiple=0.5, countOnlyBest=TRUE)
small_wham_svgr$truth_matches <- countBreakpointOverlaps(small_wham_svgr, 
                                             truth_svgr, 
                                             maxgap=100, sizemargin=0.25,
                                             restrictMarginToSizeMultiple=0.5, countOnlyBest=TRUE)
small_svaba_svgr$truth_matches <- countBreakpointOverlaps(small_svaba_svgr, 
                                             truth_svgr, 
                                             maxgap=100, sizemargin=0.25,
                                             restrictMarginToSizeMultiple=0.5, countOnlyBest=TRUE)
...
```{r USE precision recall plot <ORIGINAL>, eval=FALSE}
# indiv. version
...
```{r USE precision recall plot <SUBSET BAR>, eval=FALSE}
# indiv. version
# plot
...
```{r USE precision recall plot <SUBSET POINTS>, eval=FALSE}
## recall rate
as.data.frame(svgr) %>%
...
# to include the 50pc set
# use the NA12878_benchmark.R
PR=plyr::join(PR, fiftypc, type="full")

# reorder panel header level for plot later
...
```{r Ten pairwise comparisons, eval=FALSE}
...
```{r Annotate with caller number, eval=FALSE}
