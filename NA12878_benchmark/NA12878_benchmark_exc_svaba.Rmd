---
title: "Benchmarking NA12878 SVs by different callers, excluding SvABA"
...
Note that there is significant improvement i.e. no "crazy duplicate rows" we see when "split" mode is used for AnnotSV (See Introduction).
...
ggplot(benchmark.master, aes(x = CHROM, fill=Caller)) + # set x=chrom if want to include sample size, n (overlapping issue)
    ...
    ggtitle("SV location by caller in NA12878, excluding SvABA")

ggsave("SV_location_NA12878_updated.png")
```
