...
output:
  ...
  html_document:
    ...
    toc_float:
      ...
      smooth_scroll: yes
vignette: |
  %\VignetteIndexEntry{Structural Variant Annotation Package} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
...
This is the format that most users will be familiar with.
